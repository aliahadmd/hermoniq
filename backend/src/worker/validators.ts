...
export const habitFilterSchema = z.enum(["all", "due_today", "completed_today"]);

export const habitInsightsQuerySchema = z.object({
...
export const habitPreferenceSchema = z.object({
  ...
  defaultFilter: habitFilterSchema.optional(),
...
export const aiActionTypeSchema = z.enum([
  ...
  "event_update",
  "event_delete",
  // Legacy value kept for backward compatibility with already-stored rows.
  "create_note",
]);
export const aiActionStatusSchema = z.enum(["pending", "confirmed", "canceled", "expired"]);
