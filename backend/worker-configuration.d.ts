/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d1a40745e3018cf928d59cb41c0d1b6f)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "AiChatSessionAgent";
	}
	interface Env {
		AI_CHAT_MEDIA_BUCKET: R2Bucket;
		DB: D1Database;
		CHAT_MEMORY_INDEX: VectorizeIndex;
		AI: Ai;
